...
export function NodeInfoPanel({info, onClose, onSelectArtist}: NodeInfoPanelProps) {
        ...
        >
            ...
            <div className="mb-3 flex items-start justify-between">
                <div className="min-w-0 flex-1">
                    <h2 className="truncate text-lg font-semibold leading-tight">{info.label}</h2>
            ...
            <div className="mb-3 grid grid-cols-2 gap-2 text-sm">
                ...
                <div className="rounded bg-white/5 px-2 py-1.5">
                    <div className="text-[10px] uppercase tracking-wider text-white/40">Country</div>
                    <div className="font-medium">{info.topCountry || '—'}</div>
                </div>
            </div>

            <div className="mb-2 rounded bg-white/5 px-2 py-1.5 text-sm">
                <div className="text-[10px] uppercase tracking-wider text-white/40">Connections</div>
                <div className="font-medium">{info.connections.length.toLocaleString()} artists</div>
            </div>
